...
export const SupervisorStatsModal = ({
  isOpen,
  onClose,
  userId,
  supervisorName,
}: SupervisorStatsModalProps) => {
      ...
      <DialogContent className="sm:max-w-[900px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl">
            Estadísticas de {supervisorName}
          </DialogTitle>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div
                    className={`text-xs flex items-center gap-1 ${getTrendColor(stats.completion_trend)}`}
                  >
                    {getTrendIcon(stats.completion_trend)}
                    {stats.completion_trend > 0 ? "+" : ""}
                    {stats.completion_trend}% vs mes anterior
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-2xl font-bold">
                    {stats.avg_task_completion}%
                  </p>
                  <p className="text-xs text-gray-500">
                    {stats.completed_tasks} de {stats.total_tasks}
                  </p>
                </CardContent>
              </Card>
            </div>
                  ...
                  {chartData.map((entry) => {
                    ...
                    const percentage =
                      stats.total_activities > 0
                        ? (
                            (entry.value / stats.total_activities) *
                            100
                          ).toFixed(1)
                        : 0;
