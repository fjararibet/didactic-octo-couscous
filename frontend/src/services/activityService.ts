...
export const activityService = {
  ...
  // Get all activities for a supervisor
  async getActivitiesBySupervisor(supervisorId: number): Promise<Activity[]> {
    const response = await authService.fetchWithAuth(`${API_URL}/activities/by-supervisor/${supervisorId}`);
